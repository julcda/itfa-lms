...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('messages.dashboard')); ?> — <?php echo e(setting('school_name', 'School')); ?> Admin</title>
...
<body class="flex h-screen overflow-hidden bg-slate-100 text-gray-900 antialiased">
    ...
    <aside id="sidebar"
        ...
        <div class="flex items-center gap-3 px-4 py-[14px] shrink-0 relative" style="border-bottom: 1px solid rgba(255,255,255,0.07); background: linear-gradient(180deg, rgba(16,185,129,0.12) 0%, transparent 100%)">
            ...
            <?php if($schoolLogo): ?>
                <img src="<?php echo e(Storage::disk('public')->url($schoolLogo)); ?>" alt="logo" class="w-9 h-9 rounded-xl object-contain shrink-0" style="background:#fff;padding:2px">
            <?php else: ?>
                <div class="w-9 h-9 rounded-xl flex items-center justify-center text-white font-black text-sm shrink-0" style="background: linear-gradient(135deg, #34d399 0%, #059669 60%, #047857 100%); box-shadow: 0 4px 14px rgba(16,185,129,0.45);">
                    <?php echo e(strtoupper(substr(setting('school_short_name','S'), 0, 2))); ?>

                </div>
            <?php endif; ?>
            <div class="brand-text overflow-hidden flex-1 min-w-0">
                <div class="text-white font-bold text-[13px] truncate leading-tight"><?php echo e(school_name()); ?></div>
        ...
        <div class="mx-3 mt-3 mb-1 p-2.5 rounded-xl bg-white/[0.05] border border-white/[0.07] flex items-center gap-2.5 shrink-0">
            ...
            <div class="user-info overflow-hidden flex-1 min-w-0">
                <div class="text-white text-[12px] font-semibold truncate leading-tight"><?php echo e(auth()->user()->name); ?></div>
        ...
        <nav id="sidebar-nav" class="flex-1 overflow-y-auto px-3 py-2 space-y-px">
            ...
            <p class="section-label text-[10px] font-bold uppercase px-2 pt-2 pb-1" style="color:rgba(52,211,153,0.7)"><?php echo e(__('messages.overview')); ?></p>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.dashboard')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.dashboard')); ?></span>
            </div>

            
            <?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'admin')): ?>
            <p class="section-label text-[10px] font-bold uppercase px-2 pt-4 pb-1" style="color:rgba(96,165,250,0.75)"><?php echo e(__('messages.administration')); ?></p>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.users')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.users')); ?></span>
            </div>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.categories')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.categories')); ?></span>
            </div>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.settings.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.settings.*') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.settings')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.settings')); ?></span>
            </div>
            <?php endif; ?>

            
            <p class="section-label text-[10px] font-bold uppercase px-2 pt-4 pb-1" style="color:rgba(45,212,191,0.75)"><?php echo e(__('messages.academics')); ?></p>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.courses.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.courses.*') || request()->routeIs('admin.lessons.*') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.courses')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.courses')); ?></span>
            </div>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.books.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.books.*') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.e_library')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.e_library')); ?></span>
            </div>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.teacher-materials.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.teacher-materials.*') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.teacher_library')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.teacher_library')); ?></span>
            </div>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.quizzes.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.quizzes.*') || request()->routeIs('admin.quiz-questions.*') ? 'active' : ''); ?>">
                    <span class="nav-icon-wrap" style="background:rgba(167,139,250,0.15);color:#a78bfa"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></span>
                    <span class="nav-label"><?php echo e(__('messages.quizzes')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.quizzes')); ?></span>
            </div>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.attendance.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.attendance.*') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.attendance')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.attendance')); ?></span>
            </div>
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('admin.certificates.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.certificates.*') ? 'active' : ''); ?>">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.certificates')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.certificates')); ?></span>
            </div>
        </nav>
        ...
        <div class="px-3 py-3 border-t border-white/[0.07] space-y-px shrink-0">
            <div class="nav-item-wrap">
                <a href="<?php echo e(route('home')); ?>" target="_blank" class="nav-item">
                    ...
                    <span class="nav-label"><?php echo e(__('messages.view_site')); ?></span>
                </a>
                <span class="nav-tooltip"><?php echo e(__('messages.view_site')); ?></span>
            </div>
            <div class="nav-item-wrap">
                <form method="POST" action="<?php echo e(route('logout')); ?>" class="w-full">
                    ...
                    <button type="submit" class="nav-item" style="color:rgba(252,165,165,0.8)">
                        ...
                        <span class="nav-label"><?php echo e(__('messages.logout')); ?></span>
                    </button>
                </form>
                <span class="nav-tooltip"><?php echo e(__('messages.logout')); ?></span>
            </div>
        </div>
    </aside>
    <!-- ══════════════ MAIN AREA ══════════════ -->
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="border-b px-4 lg:px-6 py-3 flex items-center justify-between gap-4 shrink-0" style="background: linear-gradient(90deg, #ffffff 0%, #f0fdf4 100%); border-color: #e2f5eb; box-shadow: 0 1px 8px rgba(16,185,129,0.07);">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-[15px] font-semibold text-gray-800 leading-tight"><?php echo $__env->yieldContent('page-title', __('messages.dashboard')); ?></h1>
                    <?php if (! empty(trim($__env->yieldContent('breadcrumbs')))): ?>
                        <nav class="text-[11px] text-gray-400 mt-0.5"><?php echo $__env->yieldContent('breadcrumbs'); ?></nav>
                    <?php endif; ?>
                </div>
            </div>
            <div class="flex items-center gap-2">
                <div class="flex items-center bg-gray-100 rounded-lg p-1 gap-0.5">
                    <a href="<?php echo e(route('locale.switch', 'ar')); ?>" class="px-2.5 py-1 rounded-md text-xs font-semibold transition <?php echo e(app()->getLocale()==='ar' ? 'bg-white text-emerald-700 shadow-sm' : 'text-gray-500 hover:text-gray-700'); ?>">عربي</a>
                    <a href="<?php echo e(route('locale.switch', 'en')); ?>" class="px-2.5 py-1 rounded-md text-xs font-semibold transition <?php echo e(app()->getLocale()==='en' ? 'bg-white text-emerald-700 shadow-sm' : 'text-gray-500 hover:text-gray-700'); ?>">EN</a>
                </div>
                <div class="hidden sm:block text-xs text-gray-400 bg-gray-50 border border-gray-200 rounded-lg px-3 py-1.5"><?php echo e(now()->format('d M Y')); ?></div>
            </div>
        </header>
        ...
        <div class="px-4 lg:px-6 space-y-2 mt-3 empty:mt-0">
            ...
            <div class="bg-red-50 border border-red-200 text-red-800 rounded-xl px-4 py-3 text-sm shadow-sm">
                <div class="font-semibold mb-1 flex items-center gap-2">
                    ...
                    <?php echo e(__('messages.fix_errors')); ?>

                </div>
                <ul class="<?php echo e(app()->getLocale()==='ar' ? 'me-4' : 'ms-4'); ?> list-disc space-y-0.5">
...
<?php /**PATH C:\xampp\htdocs\lms\resources\views/layouts/admin.blade.php ENDPATH**/ ?>